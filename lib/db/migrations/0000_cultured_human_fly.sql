...
--> statement-breakpoint
CREATE TABLE "sales_mrp_details" (
	"id" serial PRIMARY KEY NOT NULL,
	"brand_number" text NOT NULL,
	"brand_name" text NOT NULL,
	"size" text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX "daily_sales_brand_size_date_idx" ON "daily_sales" USING btree ("brand_number","size","sale_date");--> statement-breakpoint
CREATE INDEX "daily_sales_sale_date_idx" ON "daily_sales" USING btree ("sale_date");--> statement-breakpoint
CREATE UNIQUE INDEX "daily_stock_brand_size_date_idx" ON "daily_stock" USING btree ("brand_number","size","date");--> statement-breakpoint
CREATE UNIQUE INDEX "sales_mrp_brand_size_idx" ON "sales_mrp_details" USING btree ("brand_number","brand_name","size","product_type");